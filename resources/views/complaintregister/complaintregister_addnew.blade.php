    ...
    <div class="card organisation">
        ...
        <div class="card-body card-padding">
            <div class="row">
                ...
                <form role="form" action="{{url('complaintregister/storedoc')}}" method="POST" enctype="multipart/form-data">
                    <div class="row">    
                        <input type="hidden" name="_token" id="_token" value="{{csrf_token()}}"/>
                        <input type="hidden" name="complaint_register_id" id="complaint_register_id" value="{{$id}}"/>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <input type='file' class="form-control input-sm" id="doc_upload" name="doc_upload[]" multiple >
...
<script>
    $(function(){
        ...
        $("#doc_type").on("change",function()
        {
            ...
            $("#doc_upload").attr('accept',doctype);
