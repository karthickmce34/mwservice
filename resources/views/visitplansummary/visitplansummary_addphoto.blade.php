    ...
    <div class="card organisation">
        ...
        <div class="card-body card-padding">
            <div class="row">
                ...
                <form role="form" action="{{url('visitplansummary/storephoto')}}" method="POST" enctype="multipart/form-data">
                    <div class="row">    
                        <input type="hidden" name="_token" id="_token" value="{{csrf_token()}}"/>
                        <input type="hidden" name="visitplansummary_id" id="visitplansummary_id" value="{{$id}}"/>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn btn-info btn-file">
                                                ...
                                                <input type='file' class="form-control input-sm" id="doc_upload" name="doc_upload" accept="image/x-png,image/gif,image/jpeg">
                                            </span>
