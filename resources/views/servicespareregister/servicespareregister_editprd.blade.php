    ...
    <div class="card organisation">
        ...
        <div class="card-body card-padding">
            <div class="row">
                ...
                <form role="form" action="{{url('servicespareregister/updateprd')}}/{{$id}}" method="POST" enctype="multipart/form-data">
                    <div class="row">    
                        <input type="hidden" name="_token" id="_token" value="{{csrf_token()}}"/>
                        <input type="hidden" name="_method" id="_method" value="PUT"/>
                        <input name="id" type="hidden" value="{{$id}}">
                        <input name="service_spares_register_id" type="hidden" value="{{$spprds->service_spares_register_id}}">
                        <div class="form-group col-sm-6">
                            <label for="product" class="control-label col-sm-3 required">Product Name</label>
                            <div class="col-sm-9">
                                <div class="fg-line prd">
                                    <input type="hidden" name="product_id" id="product_id" value="{{$spprds->product_id}}"/>
                                    <input type="text" class="input-sm col-sm-12" name="prd_description" id="prdname" value="{{$spprds->prd_description}}"/>
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <input type='text' class="form-control input-sm" id="unit_price" name="unit_price" value="{{$spprds->unit_price}}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-sm-2">
                            ...
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <input type='text' class="form-control input-sm" id="quantity" name="quantity" value="{{$spprds->quantity}}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-sm-2">
                            ...
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <input type='text' class="form-control input-sm" readonly id="total_price" name="total_price" value="{{$spprds->total_price}}" />
                                </div>
                            </div>
                        </div>
                    </div>
