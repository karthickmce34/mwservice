    ...
    <div class="card organisation">
        ...
        <div class="card-body card-padding">
            <div class="row">
                ...
                <form role="form" action="{{url('serviceengineer')}}/{{$modelData->id}}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="img_upload" class="control-label col-sm-3">Photo</label>
                                <div class="col-sm-9">
                                    <div class="fg-line">
                                        <div class="fileinput fileinput-exists" data-provides="fileinput">
                                            ...
                                            <div>
                                                <span class="btn btn-info btn-file">
                                                    ...
                                                    <input type='file' class="form-control input-sm" id="img_upload" name="img_upload" value="{{$modelData->file_name}}">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
