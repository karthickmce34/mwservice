    ...
    <div class="card organisation">
        ...
        <div class="card-body card-padding">
            <div class="row">
                ...
                <form role="form" action="{{url('visitplan/storephoto')}}" method="POST" enctype="multipart/form-data">
                    <div class="row">    
                        <input type="hidden" name="_token" id="_token" value="{{csrf_token()}}"/>
                        <input type="hidden" name="visitplan_id" id="visitplan_id" value="{{$id}}"/>
                        <div class="form-group col-sm-6">
                            <label for="doc_name" class="control-label col-sm-3 required">Engineer Name</label>
                            <div class="col-sm-9">
                                <div class="fg-line">
