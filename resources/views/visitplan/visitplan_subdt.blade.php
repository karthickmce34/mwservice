        ...
        <div class="panel-group" data-collapse-color="amber" role="tablist" aria-multiselectable="true">
            <div class="panel panel-collapse">
                <div class="panel-heading color-block bgm-lightblue" role="tab" id="headingPhoto">
                    <h4 class="panel-title">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapsePhoto" aria-expanded="false" aria-controls="collapseOne">
                            Site Engineer Photo
                        </a>
                    </h4>
                </div>
                <div id="collapsePhoto" class="collapse" role="tabpanel" aria-labelledby="headingPhoto">
                    <div class="panel-body p-10">
                        @if($record->visit_status == 0)
                            @if($record->is_agent==1)
                            <div class="p-5 pull-right mm-55-0">
                                <a href="{{url('visitplan/addphoto', $record->id)}}" target="_self">
                        ...
                        <div class="row ">  
                            <div class="col-sm-12">
                                ...
                                <div class="panel card" data-collapse-color="cyan" id="accordionCyan" role="tablist" aria-multiselectable="true">
                                            ...
                                            @foreach($record->photos as $photo)
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="card">
                                                        <div class="card-body card-padding pd-10-20">
                                                            <div class="row" style="padding: 8px 0 8px 0px;">
                                                                <div class="col-sm-2">{{$photos->name}}</div>
                                                                <div class="col-sm-4 ">
                                                                    <img alt="{{$photos->name}}" style="width: inherit;" src="{{url('/')}}/{{$photo->file_path}}/{{$photo->file_name}}" />

                                                                </div>
                                                                <div class="col-sm-2 text-center">
                                                                    <a href="{{url('visitplan/editphoto', $photo->id)}}" target="_self">
                                                                        <button class="btn bgm-orange btn-icon waves-effect waves-circle waves-float"><i class="zmdi zmdi-edit"></i></button>
                                                                    </a>
                                                                    <a href="{{url('visitplan/deletephoto', $photo->id)}}" target="_self">
                                    ...
                                    @else 
                                        <div class="row">
                                            @foreach($record->visitengs as $visiteng)
                                                <?php $n++; ?>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="card">
                                                        <div class="card-body card-padding pd-10-20">
                                                            <div class="row" style="padding: 8px 0 8px 0px;">
                                                                <div class="col-sm-2">{{$visiteng->engineer->name}}</div>
                                                                <div class="col-sm-4 ">
                                                                        <img style="width: inherit;" src="{{url('/')}}/{{$visiteng->engineer->file_path}}/{{$visiteng->engineer->file_name}}" />
