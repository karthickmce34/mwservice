    ...
    <div class="card organisation">
        ...
        <div class="card-body card-padding">
            <div class="row">
                ...
                <form role="form" action="{{url('serviceagent')}}" method="POST" enctype="multipart/form-data">
                    <div class="row">    
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <input class="form-control input-sm" placeholder="Agent/Company Name" name="company_name" type="text" id="company_name" data-validation="required" required="required">                                        
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <div class="fg-line">
                                    <input class="form-control input-sm" placeholder="Contact Person" name="contact_person" type="text" id="contact_person" data-validation="required" required="required">                                        
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
