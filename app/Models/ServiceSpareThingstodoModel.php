...
class ServiceSpareThingstodoModel extends BaseModel {
    ...
    protected $fillable = array('id','service_spares_register_id','visitplan_id','things_to_do','answer_type','created_by_id','status','created_at','updated_at');    
    protected $selectable = array('service_spares_product.id','service_spares_product.service_spares_register_id','service_spares_product.visitplan_id','service_spares_product.things_to_do','service_spares_product.answer_type','service_spares_product.created_by_id','service_spares_product.status','service_spares_product.created_at','service_spares_product.updated_at');
