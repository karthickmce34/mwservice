...
class ComplaintRegisterModel extends BaseModel {
    ...
    protected $fillable = array('id','seqno','mode_of_complaint','complaint_type','complaint_date','customer_name','address1','address2','city','state','pincode','phoneno','mobileno','gstin','panno','emailid','contact_person','contact_number','salesorder_no','serial_no','order_type','site_location','panel_descrption','commissioned_date','complaint_nature','outgoing_load','relay_make_type','relay_status','cable_length','fault_current','vcb_interlock','after_commissioned','event_before_failure','warrenty','date_supply','complaint_status','document_status','solved_date','payment_status','order_status','remark','eheader_id','ticket_id','region_id','created_by_id','status','created_at','updated_at');    
    protected $selectable = array('complaint_register.id','complaint_register.seqno','complaint_register.mode_of_complaint','complaint_register.complaint_type','complaint_register.complaint_date','complaint_register.customer_name','complaint_register.address1','complaint_register.address2','complaint_register.city','complaint_register.state','complaint_register.pincode','complaint_register.phoneno','complaint_register.mobileno','complaint_register.gstin','complaint_register.panno','complaint_register.emailid','complaint_register.contact_person','complaint_register.contact_number','complaint_register.salesorder_no',
                                   ...
                                   'complaint_register.outgoing_load','complaint_register.relay_make_type','complaint_register.relay_status','complaint_register.cable_length','complaint_register.fault_timestamp','complaint_register.vcb_interlock','complaint_register.after_commissioned','complaint_register.order_type','complaint_register.site_location',
