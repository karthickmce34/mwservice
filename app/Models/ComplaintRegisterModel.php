...
class ComplaintRegisterModel extends BaseModel {
    ...
    protected $fillable = array('id','seqno','mode_of_complaint','complaint_type','complaint_date','customer_name','address1','address2','city','state','pincode','phoneno','mobileno','gstin','panno','emailid','contact_person','salesorder_no','serial_no','order_type','site_location','panel_descrption','commissioned_date','complaint_nature','outgoing_load','relay_make_type','relay_status','cable_length','fault_current','vcb_interlock','after_commissioned','event_before_failure','warrenty','date_supply','complaint_status','document_status','solved_date','payment_status','order_status','remark','eheader_id','region_id','created_by_id','status','created_at','updated_at');    
