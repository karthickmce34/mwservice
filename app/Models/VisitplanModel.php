...
class VisitplanModel extends BaseModel {
    ...
    protected $selectable = array('visit_plan.id','visit_plan.complaint_register_id','visit_plan.servicespare_id','visit_plan.is_agent','visit_plan.agent_id',
        ...
        'visit_plan.loading_expenses','visit_plan.boarding_expenses','visit_plan.travel_expenses',
                                    'visit_plan.tools_required','visit_plan.local_conveyance','visit_plan.material_requirements','visit_plan.contact_person','visit_plan.contact_number','visit_plan.visit_completed_date','visit_plan.visit_status','visit_plan.created_by_id','visit_plan.status','visit_plan.created_at','visit_plan.updated_at');
    ...
    public function visitAssests()
    {
        return $this->hasMany('App\Models\VisitplanAssetModel','visitplan_id','id');
    }
