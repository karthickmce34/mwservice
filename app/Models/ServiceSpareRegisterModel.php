...
class ServiceSpareRegisterModel extends BaseModel {
    ...
    protected $fillable = array('id','complaint_register_id','complaint_type','site_eng_id','order_no','priority','paid_date','payment_mode','failure_cause','scope_of_work','scope_of_work_o','department','things_to_take','things_to_do','isbom','site_depute','po_ref','po_date','order_status','offer_date','pi_date','dispatch_date','advance_amt','total_gross_amt','payment_received','final_offer_id','cancel_remark','completed_date','created_by_id','status','created_at','updated_at');    
    protected $selectable = array('service_spares_register.id','service_spares_register.complaint_register_id','service_spares_register.order_no','service_spares_register.complaint_type','service_spares_register.department','service_spares_register.site_eng_id','service_spares_register.priority','service_spares_register.paid_date','service_spares_register.payment_mode','service_spares_register.failure_cause','service_spares_register.scope_of_work','service_spares_register.scope_of_work_o','service_spares_register.things_to_take','service_spares_register.things_to_do','service_spares_register.isbom','service_spares_register.site_depute','service_spares_register.po_ref','service_spares_register.po_date','service_spares_register.order_status','service_spares_register.offer_date','service_spares_register.pi_date','service_spares_register.dispatch_date','service_spares_register.advance_amt','service_spares_register.total_gross_amt','service_spares_register.payment_received','service_spares_register.final_offer_id','service_spares_register.cancel_remark','service_spares_register.completed_date','service_spares_register.created_by_id','service_spares_register.status','service_spares_register.created_at','service_spares_register.updated_at');
