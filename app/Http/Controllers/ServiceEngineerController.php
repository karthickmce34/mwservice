...
use App\Models\ServiceEngineerModel;


class ServiceEngineerController extends Controller
{
    public $modelName       = 'App\Models\ServiceEngineerModel';
    public $baseRedirect    = 'serviceengineer.index';
    public $baseName        = 'serviceengineer';
    public $basePath        = 'serviceengineer/';
    public $detailName   = 'ServiceEngineerController@getIndex';
