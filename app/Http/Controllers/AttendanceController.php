...
{
    public $modelName       = 'App\Models\AttendanceModel';
    
    public $baseRedirect    = 'attendance.index';
    public $baseName        = 'attendance';
    public $basePath        = 'attendance/';
    public $detailName      = 'AttendanceController@getIndex';
